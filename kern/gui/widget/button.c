 ...
 * @my: 鼠标纵坐标
 */
static void KGC_ButtonMouseDown(KGC_Widget_t *widget, int btn, int mx, int my)
{
 ...
 * @my: 鼠标纵坐标
 */
static void KGC_ButtonMouseUp(KGC_Widget_t *widget, int btn, int mx, int my)
{
    KGC_Button_t *button = (KGC_Button_t *) widget;
    KGC_Label_t *label = &button->label;
 ...
 * @my: 鼠标纵坐标
 */
static void KGC_ButtonMouseMotion(KGC_Widget_t *widget, int mx, int my)
{
    KGC_Button_t *button = (KGC_Button_t *) widget;
    KGC_Label_t *label = &button->label;
...
{
    KGC_Button_t *button = kmalloc(sizeof(KGC_Button_t));
    if (button == NULL) {
        return NULL;
    }
