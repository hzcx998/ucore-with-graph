...
# qemu-system-i386 -S -s -parallel stdio -serial null -drive file=bin/ucore.img,format=raw,media=disk,cache=writeback -drive file=bin/swap.img,format=raw,media=disk,cache=writeback -drive file=bin/sfs.img,format=raw,media=disk,cache=writeback 
